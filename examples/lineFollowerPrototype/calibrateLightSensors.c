 ...
 * background.
 */
const int sensorOnLineThreshold = 40;
 ...
 * make corrections.
 */
const float turnRateMulitplier = baseMotorPower/15;
...
task main()
{
  initializeIndividualMotor(rightMotor, 15);
  initializeIndividualMotor(leftMotor, 15);
  ...
  disableDiagnosticsDisplay();
   ...
   while (!stopLineFollower())
   {
      ...
      float turnFactor = (leftLineSensorValue - rightLineSensorValue + sensorCal)*turnRateMulitplier;
