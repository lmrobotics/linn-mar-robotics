...
const int degreeToRevolutionConvertionFactor=floor(1440.0/360.0);
...
//****************************************************************
//**** End of Definte Movement


//****************************************************************
//**** Start of indefinte movements
void Forward(int motorPower){
        motor[motorLF]=motorPower;
        motor[motorRF]=motorPower;
        motor[motorLB]=motorPower;
...
//******************************************************************
//**** End of Indefinite Movements

//********************************************************************
//** Start of PreLineFollowTweak
void preLineFollowTweak(){
