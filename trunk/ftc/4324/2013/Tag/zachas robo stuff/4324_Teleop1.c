...
task main()
{
	...
	wait1Msec(367); //travel time
	park(); //stop at basket
	wait1Msec(3000); //wait for arm and bucket
	servo[basketServo]=basketServoStart; //drop bucket and cube
	wait1Msec(850); //process time
	motor[armMotor]=armMotorDown; //lower the arm
	wait1Msec(850);  //wait for the arm to reach a safe position
